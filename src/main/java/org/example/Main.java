...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Result of array equals is -> " + playGround.arrayEquals(new Integer[]{1, 2, 3}, new Integer[]{1, 2, 3}));
        System.out.println("Result of the longest sub string -> " + playGround.longestSubString("aabbbbbccddb"));
        System.out.println("Result of longest sub string index and array -> " + Arrays.toString(playGround.longestSubStringIndexLength("aabbbbbccddb")));

        System.out.println("Maximum gold collected -> " + playGround.goldCollected(new int[][]{{0,0,0,0,5}, {0,1,1,1,0}, {2,0,0,0,0}}));
    }
